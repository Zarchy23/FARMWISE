...
# ============================================================
# SECURITY HEADERS & HTTPS (Production Hardening)
# ============================================================
if not DEBUG:
    # HTTPS & SSL/TLS
...
CELERY_BEAT_SCHEDULE = {
    ...
    'send-health-reminder-emails': {
        ...
        'schedule': timedelta(hours=24),  # Daily - send reminder emails for health records due soon
    },
...
# Ignore media folder and other non-static content during collectstatic
